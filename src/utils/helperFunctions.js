...
export const getLocationDetails = () => {
  const locationDetails = {
    name: localStorage.getItem("location_name") || "Amritsar I Tahsil, Punjab, 143001, India",
    lat: localStorage.getItem("location_lat") || 31.6343083,
    lng: localStorage.getItem("location_lng") || 74.8736788,
  };
